...
<tr>
  ...
  <td>
    <?php 
      if ($pro['keterangan'] == "Sakit") {
        echo '<b style="color: green;">Sakit</b>';
      } else if($pro['keterangan'] == "Izin"){
        echo '<b style="color: green;">Izin</b>';
      } else if($pro['keterangan'] == "Cuti"){
        echo '<b style="color: green;">Cuti</b>';
      } else if($pro['keterangan'] == "Dinas"){
        echo '<b style="color: green;">Dinas</b>';
      }
    ?>
  </td>
  <td><?=  $pro['alasan'];?></td>
  ...
  <td>
    <button class="btn btn-danger" data-toggle="modal" data-target="#hapus_ket<?=$pro['id'];?>">hapus</button>
